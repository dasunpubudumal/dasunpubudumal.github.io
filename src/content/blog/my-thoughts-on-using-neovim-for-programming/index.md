...
Also, I think plugins like [Telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) (which is built-in in LazyVim) - created by the YouTuber [teej_dv](https://www.youtube.com/@teej_dv), and [harpoon](https://github.com/theprimeagen/harpoon) - created by theprimeagen himself, makes stuff easier to not to have a sidebar. Telescope is a fuzzy-finding solution; I’ve mapped `<leader>ff` to open it along with a few [pickers](https://github.com/nvim-telescope/telescope.nvim#pickers) to hide some dotfiles that I don’t want to search (`.git` ones)
